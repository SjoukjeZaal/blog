...
When I installed the Cumulative Update for Workflow Manager 1.0 I
...
Navigating to the workflow management site gave me a 500 internal server
error.
...
at
Microsoft.Workflow.Common.Fx.\<\>c\_\_DisplayClass2.\<FailFast\>b\_\_0()
...
It seems that there are some configuration values missing from the
Workflow Resource Management Database. Add the below values to the
**WorkflowServiceConfig** table:
...
Restart the Workflow Manager Backend Service and navigate to the
Workflow Management Site. You should be seeing the below information on
the page:
